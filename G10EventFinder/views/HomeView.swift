...
//                            self.loadDataFromAPI(lat: searchLat, lng: searchLat)
    ...
    func loadDataFromAPI(lat:String = "45.5019", lng:String = "-73.5674"){
        ...
        // specify API url
        let websiteAddress:String = "https://api.seatgeek.com/2/events?lat=\(lat)&lon=\(lng)&client_id=xxxxxxxxxxxxxxxxxxxxxxxxxxx"
        ...
        // Using the network request object, connect to the api
        // Handle the results from the API (if any)
